...
export function operationField<T extends Entity>(resourceId: string, width?: string) {
...
export async function renderOperationButtons<T extends { id: string }, P extends ListPageProps>
    ...
    let controlElements = children.map((o, i) => funcs[i]({ resource: o, dataItem, listPage: listPage }));
